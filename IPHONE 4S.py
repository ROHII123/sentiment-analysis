# -*- coding: utf-8 -*-
"""
Created on Fri Jun 24 15:15:49 2022

@author: Nitin_Kondaval
"""
...
image = Image.open("C:/Users/Nitin_Kondaval/Downloads/sentiment analysis.jpg")
st.image(image)

    
# Import Model 
model = pickle.load(open("C:/Users/Nitin_Kondaval/Desktop/New folder/final_model (1).pkl",'rb'))
